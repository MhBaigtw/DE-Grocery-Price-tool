...
### tool/
**Purpose:** The static price-lookup tool's data extract — `meta.json`, `products.json`, `history.json`, generated by `analysis/phase4/E1_tool_extract.sql`.
